...
export const PricingPlans: iAppProps[] = [
  {
    id: 0,
    cardTitle: "Student Pack",
    cardDescription: "The best pricing plan for students that starting out.",
    benefits: [
      "1 User",
      "Basic Professor Recommendations",
  ...
  {
    id: 1,
    cardTitle: "Universities Pack",
    cardDescription: "The best plan for education professionals.",
    priceTitle: "$99/year",
    benefits: [
      "Unlimited Users",
      "Advanced Professor Recommendations",
  ...
  return (
    <>
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center leading-tight text-muted-foreground">
        Join us in transforming your academic experience. With EduAI, find top educators and make informed choices with ease.
      </p>
